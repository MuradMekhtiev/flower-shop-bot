...
Проект развёрнут на Railway и работает 24/7.

🔗 **Веб-админка:** [https://flower-shop-bot-production-8a13.up.railway.app](https://flower-shop-bot-production-8a13.up.railway.app)

Демо-доступ:
- **Логин:** `demo`
- **Пароль:** `demo123`

🤖 **Telegram-бот:** [@demo_flower_shop_bot](https://t.me/demo_flower_shop_bot)

> ⚠️ Это демо-инстанс на бесплатном тарифе Railway. БД и фото сохраняются между деплоями через persistent volume. Демо-доступ публичный, поэтому не используйте реальные данные. Содержимое БД может периодически сбрасываться.
...
✅ Этот проект уже развёрнут на Railway — см. раздел [Live Demo](#-live-demo) выше.
